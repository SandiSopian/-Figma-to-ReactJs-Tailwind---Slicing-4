...
const Pagination1 = () => {
  ...
  //   const currentPageData = data.slice(offset, offset + PER_PAGE).map((item, i) => (
  //     <div key={i} className="bg-bgDefault w-[340px] sm:w-[300px] md:w-[365px] xl:w-[480px] p-4 mx-auto border shadow-lg rounded-md leading-relaxed ">
  //       <div className="font-bold text-xl">{item.nama}</div>
  //       <div className="text-titleColor">
  //         <span className="text-black">di</span> {item.alamat}
  //       </div>
